    ...
    try {
      ...
      do {
        ...
        const res = await fetch(
          `https://api.discogs.com/users/${discogsUser}/collection/folders/0/releases?page=${page}&per_page=100&sort=added&sort_order=desc`,
                    ...
                    {formStep === 1 && !editingItem ? (
                      ...
                      >
                        ...
                        <form onSubmit={handleSaveItem} className="space-y-4">
                          ...
                          {/* Grading & Details */}
                          <div className={`grid grid-cols-2 ${formFormat === 'Cassette' ? 'sm:grid-cols-3' : 'sm:grid-cols-4'} gap-4 bg-white/2 border border-white/5 p-4 rounded-2xl`}>
                            <div className="space-y-1.5 col-span-1">
